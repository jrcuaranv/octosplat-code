...
seed = 0
group_name = "eruvae_postopt"
scene_name = "plant3"
param_name = f"{scene_name}_{seed}"
run_name = f"postopt_{param_name}"
param_ckpt_path = f"./experiments/eruvae/{param_name}/params.npz"
...
config = dict(
    ...
    data=dict(
        ...
        eval_stride=5,
        eval_num_frames=20, # Set to -1 to eval all frames
    ...
    viz=dict(
        ...
        color_dict_path="./data/eruvae/color_dict.json",
